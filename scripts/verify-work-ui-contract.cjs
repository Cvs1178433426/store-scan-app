...
const checks={
 'apps/web/app/my-work/page.tsx':['Continuixai Ops','Start My Day','Overdue','Today','This week','Completed today','Start Store Scan','Do not enter patient'],
 'apps/web/app/daily-summary/page.tsx':['accomplished today','Tasks completed','Units counted','Sign out'],
 'apps/web/app/team-work/page.tsx':['Team Work','Recurring templates','One-time assignment','Team status','Reports','Job title'],
};
