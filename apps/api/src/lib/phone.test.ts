...
import { decryptPhone, encryptPhone, hashPhone, hashPhoneCandidates, maskPhone, normalizeUsPhone } from "./phone.js";
...
describe("phone protection", () => {
  ...
  it("creates lookup candidates for every configured key during rotation", () => {
    expect(hashPhoneCandidates("+16317423355")).toEqual([
      { version: 2, hash: hashPhone("+16317423355", 2) },
      { version: 1, hash: hashPhone("+16317423355", 1) },
    ]);
  });
