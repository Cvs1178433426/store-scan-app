...
const dict = {
  ...
  // Phase 3-D — 회고/발견. 사실만 (훈계 문구 금지).
  insightsTitle: { ko: "회고", en: "Insights" },
  insightsNavLabel: { ko: "회고", en: "Insights" },
  insightsDashboardLink: { ko: "이번 달 회고 보기", en: "This month’s insights" },
  insightsMonthLabel: { ko: "{year}년 {month}월", en: "{year}-{month}" },
  insightsPrevMonth: { ko: "이전 달", en: "Previous month" },
  insightsNextMonth: { ko: "다음 달", en: "Next month" },
  insightsUntouchedTitle: { ko: "{days}일 이상 손 안 댄 물건", en: "Untouched for {days}+ days" },
  insightsUntouchedHint: {
    ko: "선택한 달과 무관합니다. 지금 기준입니다.",
    en: "Not tied to the selected month — based on now.",
  },
  insightsUntouchedEmpty: { ko: "해당 기간 기준 후보가 없습니다.", en: "No candidates for this threshold." },
  insightsUntouchedDays: { ko: "{n}일 전", en: "{n} days ago" },
  insightsTopConsumedTitle: { ko: "이번 달 소비 상위", en: "Most consumed this month" },
  insightsTopConsumedEmpty: { ko: "이번 달 소비 기록이 없습니다.", en: "No consume records this month." },
  insightsConsumedQty: { ko: "{n}개", en: "{n}" },
  insightsDuplicatesTitle: { ko: "이번 달 다시 채운 것", en: "Restocked on more than one day" },
  insightsDuplicatesEmpty: {
    ko: "서로 다른 날에 다시 채운 기록이 없습니다.",
    en: "No item was restocked on more than one day.",
  },
  insightsRestockMeta: { ko: "{count}일 · {qty}개", en: "{count} days · qty {qty}" },
  insightsPurchasedTitle: { ko: "이번 달 등록·구매", en: "Added / purchased this month" },
  insightsPurchasedEmpty: { ko: "이번 달 등록된 아이템이 없습니다.", en: "No items added this month." },
  insightsPurchasedTotal: { ko: "단가 합계", en: "Unit-price total" },
  insightsPurchasedNoPrice: { ko: "가격 없음", en: "No price" },
  insightsLoadFailed: { ko: "회고를 불러오지 못했습니다.", en: "Couldn’t load insights." },
  insightsHint: {
    ko: "소비·재입고는 재고 이력 기준입니다. 구매일은 없으면 등록일을 씁니다. 단가 합계는 총 자산가치(단가×수량)와 다릅니다.",
    en: "Consume/restock use stock history. Purchase date falls back to created date when unset. Unit-price total differs from inventory value (price × qty).",
  },
