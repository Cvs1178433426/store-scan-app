  ...
  return (
    <main className="auth-page">
      <section className="auth-card" aria-labelledby="recovery-title">
        ...
        <p className="auth-intro">Enter your registered email. If it matches an active account, we will text its verified phone. Enter that code to prove it is you before choosing a new password.</p>
        <form className="form" onSubmit={startRecovery}>
          ...
          <button type="submit" disabled={loading}>{loading ? "Sending code..." : "Text me a verification code"}</button>
