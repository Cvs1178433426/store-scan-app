...
const launchers = [
  ...
  { href: "/products", title: "Products", description: "Find and manage products" },
  { href: "/locations", title: "Locations", description: "View store locations and zones" },
] as const;
  ...
  return (
    <main style={{ maxWidth: 820, margin: "0 auto", padding: "32px 18px 110px" }}>
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16, marginBottom: 34 }}>
        <BrandLockup />
        <button type="button" className="secondary" onClick={() => void logout()} style={{ width: "auto", minHeight: 42, padding: "8px 14px" }}>
          Sign Out
        </button>
      </header>
